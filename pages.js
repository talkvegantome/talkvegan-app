...
export const menu = [
  {
    "friendlyName": "30 Excuses",
    "subItems":[
      {
        "friendlyName": "Personal Choice",
        "screenId": "personalChoice"
      },
      {
        "friendlyName": "I Like The Taste",
        "screenId": "iLikeTheTaste"
      },
      {
        'friendlyName': 'Other Animals Eat Other Animals',
        'screenId': 'otherAnimals'
      },
      {
        'friendlyName': 'Animal Products for Nutrition',
        'screenId': 'animalProductsForNutrition'
      },
      {
        'friendlyName': 'Eating Animals is Traditional & Cultural',
        'screenId': 'animalProductsForTradition'
      },
      {
        'friendlyName': 'Our Ancestors Ate Animals',
        'screenId': 'ourAncestorsAteAnimals'
      },
      {
        'friendlyName': 'If We Didn\'t Eat Them They\'d Go Extinct',
        'screenId': 'theyWouldGoExtinctWithoutUs'
      }
    ]
  }
]
